...
public class RegisterDenunciaActivity extends AppCompatActivity {
    ...
    public void callRegister(View view) {
        ...
        if (titulo.isEmpty() || comentario.isEmpty()|| latitud.isEmpty()|| longitud.isEmpty()) {
        ...
        RequestBody idPart = RequestBody.create(MultipartBody.FORM, id_recibido);

        call = service.createDenunciaWithImage(tituloPart,comentarioPart,latitudPart,longitudPart,idPart,imagenPart);
